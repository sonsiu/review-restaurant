                ...
                <div class="container">
                    <div class="checkout__form">
                        ...
                        <form action="edit-blog" method="post" enctype="multipart/form-data">
                            <input type="number" name="blogID" value="${blogId}" style="display:none" >
                            <div class="row">
                                <div class="col-lg-8 col-md-6">
                                    ...
                                    <div class="checkout__input">
                                        ...
                                        <div class="tag-container">
                                            <c:forEach items="${hashtag}" var="hashtag">
                                                <span class="tag">${hashtag}<span class="remove-tag" onclick="handleRemoveTag(event)">&#10006;</span></span>
                                            </c:forEach>
                                            ...
                                            <input id="tags-array" name="tags-array" 
                                                   type="hidden" 
                                                   value="${hashtagString}">
                                        </div>
                                    ...
                                    <script>
                                        ...
                                        function checkEmptyArr() {
                                            if (tagArray.value.trim() === "") {

                                            } else {
                                                const tagStrings = tagArray.value.split(',');
                                                for (let i = 0; i < tagStrings.length; i++) {
                                                    tags.push(tagStrings[i].trim()); // Trim leading/trailing whitespace (optional)
                                                }
                                            }
                                        }
...
//                                            console.log(tags);
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="checkout__input">
                                                <p>Ảnh ban đầu<span>*</span></p>
                                                <div id="image-preview-container-multiple-old" >
                                                    <div id="image-preview-multiple-old">
                                                        <c:forEach items="${images}" var="images">
                                                            <div id="image-preview-multiple-old">
                                                                <img class="preview-image-multiple-old" src="data:image/*;base64,${images.imageLink}">
                                                            </div>
                                                        </c:forEach>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="checkout__input">
                                                <p>Ảnh hóa đơn ban đầu  <sup class="text-danger"></sup></p>
                                                <div id="image-preview-containtner-bill-old" >
                                                    <div id="image-preview-single-old">
                                                        <img class="preview-image-single-old" src="data:image/*;base64,${billImage}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="checkout__input">
                                                <p>Ảnh hóa đơn mới  <sup class="text-danger">*(Dùng cho xác minh)</sup></p>
                                                <input type="file" accept="image/*" id="billLink" name="billLink" onchange="loadFile(event)" required>
                                                <div id="image-preview-container-bill" >
                                                    <div id="image-preview-single">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="meal-type" id="sectionFormMealType">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="meal-type" value="Breakfast"
                                                                   ${isBreakfast? "checked":""} > Ăn sáng<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="meal-type" value="Lunch"
                                                                   ${isLunch? "checked":""} > Ăn trưa<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="meal-type" value="Dinner"
                                                                   ${isDinner? "checked":""} > Ăn tối<br>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="meal-type" value="Late Night"
                                                                   ${isLateNight? "checked":""} > Ăn đêm<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="meal-type" value="Brunch"
                                                                   ${isBrunch? "checked":""} > Ăn giữa trưa-sáng<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="meal-type" value="Drink"
                                                                   ${isDrink? "checked":""}> Đồ Uống<br>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="food-type" id="sectionFormFoodType">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="Vietnamese"
                                                                   ${isVietnamese? "checked":""}> Việt<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="Chinese"
                                                                   ${isChinese? "checked":""}> Trung<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="Korean"
                                                                   ${isKorean? "checked":""}> Hàn<br>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="Thai"
                                                                   ${isThai? "checked":""}> Thái<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="Europe"
                                                                   ${isEurope? "checked":""}> Âu<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="American"
                                                                   ${isAmerican? "checked":""}> Mỹ<br>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="Japanese"
                                                                   ${isJapanese? "checked":""}> Nhật<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="food-type" value="Other"
                                                                   ${isOther? "checked":""}> Khác<br>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="diet-type">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="special-diet-type" value="Vegan"
                                                                   ${isVegan? "checked":""}> Ăn chay <br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="special-diet-type" value="Glueten-free"
                                                                   ${isGlueten? "checked":""}> Không Gluten<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="special-diet-type" value="Low-fat"
                                                                   ${isLowFat? "checked":""}> Ít béo<br>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="special-diet-type" value="Diabetic Diet"
                                                                   ${isDiabetic? "checked":""}> Chế độ ăn tiểu đường<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="special-diet-type" value="High-protein"
                                                                   ${isHigh? "checked":""}> Giàu Protein<br>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="special-diet-type" value="Low-protein"
                                                                   ${isLow? "checked":""}> Ít Protein<br>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <tr class="category-content">
                                                    ...
                                                    <td width="200">
                                                        <select class="category-select" name="price-range" title="Select price range" required>
                                                            ...
                                                            <option value="$ (>10000 vnd)" ${tier1? "selected":""}> $ (>10000 vnd)</option>
                                                            <option value="$+ (10000 - 50000 vnd)"  ${tier2? "selected":""}> $+ (10000 - 50000 vnd)</option>
                                                            <option value="$$ (50001 - 200000 vnd)" ${tier3? "selected":""}> $$ (50001 - 200000 vnd)</option>
                                                            <option value="$$+ (200001 - 500000 vnd)" ${tier4? "selected":""}> $$+ (200001 - 500000 vnd)</option>
                                                            <option value="$$$ (<500000 vnd)" ${tier5? "selected":""}> $$$ (<500000 vnd)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="checkout__input">
                                        ...
                                        <table border="0" width="300">
                                            <tbody>
                                                <tr>
                                                    <td>Chất lượng</td>
                                                    <td><input type="number" placeholder="From 1 to 5" class="rate-input" name="foodQuality" id="foodQuality" min="0" max="5" value="${quality}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Không gian</td>
                                                    <td><input type="number" placeholder="From 1 to 5" class="rate-input" name="environment" id="environment" min="0" max="5" value="${environment}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Giá cả</td>
                                                    <td><input type="number" placeholder="From 1 to 5" class="rate-input" name ="pricing" id="pricing" min="0" max="5" value="${price}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Phục vụ</td>
                                                    <td><input type="number" placeholder="From 1 to 5" class="rate-input" name="service" id="service" min="0" max="5" value="${service}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Vệ sinh</td>
                                                    <td><input type="number" placeholder="From 1 to 5" class="rate-input" name="hygiene" id="hygiene" min="0" max="5" value="${hygine}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Điểm Overall</td>
                                        ...
                                        <div class="checkout__order" >
                                            ...
                                            <button type="submit" class="site-btn">Chỉnh Sửa</button>
                                        </div>
        ...
        <style>
            ...
            #image-preview-container-multiple , #image-preview-containtner-bill, #image-preview-container-multiple-old , #image-preview-containtner-bill-old {
            ...
            #image-preview-multiple, #image-preview-single,#image-preview-multiple-old, #image-preview-single-old {
                display: flex; /* Arrange images horizontally */
                flex-wrap: wrap; /* Allow images to wrap to multiple lines */
                margin: 5px; /* Add some margin for spacing */
            }

            .preview-image-multiple, .preview-image-multiple-old {
