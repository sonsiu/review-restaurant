                                    ...
                                    <div class="full counter_section margin_bottom_30">
                                        ...
                                        <div class="counter_no">
                                            <div>
                                                ...
                                                <p class="head_couter">Moderator</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="full counter_section margin_bottom_30">
                                        ...
                                        <div class="counter_no">
                                            <div>
                                                ...
                                                <p class="head_couter">Tất cả bình luận</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">Bảng Moderator</h4>
                                                                    ...
                                                                    <td>
                                                                        <c:choose>
                                                                            ...
                                                                            <c:when test="${u.status == 1}">
                                                                                <i class="fa fa-circle-o text-success  mr-2"></i>Đã được cấp 
                                                                            </c:when>
                                                                ...
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when test="${blog.status == 0}">
                                                                            <i class="fa fa-circle text-warning  mr-2"></i> Trạng thái chờ
                                                                        </c:when>
                                                                        <c:when test="${blog.status == 1 || blog.status == 3}">
                                                                            <i class="fa fa-circle text-success  mr-2"></i>Đã được duyệt
                                                                        </c:when>
                                                                        <c:when test="${blog.status == 2}">
                                                                            <i class="fa fa-circle text-danger  mr-2"></i>Bị cấm (by Mod)
                                                                        </c:when>
                                                                        <c:when test="${blog.status == 4}">
                                                                            <i class="fa fa-trash text-danger  mr-2"></i>xóa (by User)
                                                                        </c:when>
                                                                    </c:choose>
                                                                </td>
                                                                <td>${blog.rate}</td>
