 ...
 * @author Vinh
 */
@WebServlet(name="SetModStatusByAJAXController", urlPatterns={"/admin/set-mod-status"})
public class SetModStatusByAJAXController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user.getStatus() == 1) {
                ...
                request.getRequestDispatcher("show-mod").forward(request, response);
